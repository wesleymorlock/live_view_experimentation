defmodule LiveViewCoolnessWeb.TodoLiveTest do
  use LiveViewCoolnessWeb.ConnCase

  import Phoenix.LiveViewTest

  alias LiveViewCoolness.Todos

  @create_attrs %{task: "some task"}
